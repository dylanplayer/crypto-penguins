...
// TODO: add shuffle penguins function
  ...
  return (
    <>
      <Head>
        ...
        <main className="flex min-h-screen h-full flex-col items-center justify-items-stretch bg-gradient-to-b from-[#024b6d] to-[#15162c]">
          <Navbar/>
          <div className="container max-w-md flex flex-col items-center justify-center gap-12 px-4 py-16 ">
            <div className="shadow-xl flex-1 object-cover">
              <Image
                src="/assets/penguins/cryptopenguinking.png"
